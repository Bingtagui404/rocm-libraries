                                                ...
                                                const void* arrayOfElements)
{
    ...
    {
    case HIPDNN_ATTR_OPERATION_POINTWISE_IN_0:
        ...
        break;
    case HIPDNN_ATTR_OPERATION_POINTWISE_OUT_0:
    ...
    case HIPDNN_ATTR_POINTWISE_RELU_LOWER_CLIP:
        setScalar(_data.relu_lower_clip,
                  HIPDNN_TYPE_FLOAT,
                  attributeType,
                  elementCount,
                  arrayOfElements,
    ...
    case HIPDNN_ATTR_POINTWISE_RELU_UPPER_CLIP:
        setScalar(_data.relu_upper_clip,
                  HIPDNN_TYPE_FLOAT,
                  attributeType,
                  elementCount,
                  arrayOfElements,
    ...
    case HIPDNN_ATTR_POINTWISE_RELU_LOWER_CLIP_SLOPE:
        setScalar(_data.relu_lower_clip_slope,
                  HIPDNN_TYPE_FLOAT,
                  attributeType,
                  elementCount,
                  arrayOfElements,
    ...
    case HIPDNN_ATTR_POINTWISE_SOFTPLUS_BETA:
        setScalar(_data.softplus_beta,
                  ...
                  "PointwiseOperationDescriptor::setAttribute()");
        break;
    case HIPDNN_ATTR_POINTWISE_COMP_TYPE:
                                                ...
                                                void* arrayOfElements) const
{
    ...
    case HIPDNN_ATTR_POINTWISE_MODE:
        ...
        break;
    case HIPDNN_ATTR_POINTWISE_RELU_LOWER_CLIP:
        getScalar(_data.relu_lower_clip,
                  HIPDNN_TYPE_FLOAT,
                  attributeType,
                  requestedElementCount,
                  elementCount,
        ...
        break;
    case HIPDNN_ATTR_POINTWISE_RELU_UPPER_CLIP:
        getScalar(_data.relu_upper_clip,
                  HIPDNN_TYPE_FLOAT,
                  attributeType,
                  requestedElementCount,
                  elementCount,
        ...
        break;
    case HIPDNN_ATTR_POINTWISE_RELU_LOWER_CLIP_SLOPE:
        getScalar(_data.relu_lower_clip_slope,
                  HIPDNN_TYPE_FLOAT,
                  attributeType,
                  requestedElementCount,
                  elementCount,
...
{
    return {_in0Desc, _out0Desc, _in1Desc, _in2Desc, _axisDesc};
}
