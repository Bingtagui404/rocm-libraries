...
struct BlockScaleDequantizeSignatureKey
{
    ...
    constexpr BlockScaleDequantizeSignatureKey(hipdnn_data_sdk::data_objects::DataType x,
        ...
        getPlanBuilders()
    {
        ...
        addPlanBuilder<hipdnn_data_sdk::data_objects::DataType::FP8_E4M3,
                       hipdnn_data_sdk::data_objects::DataType::FP8_E8M0,
                       hipdnn_data_sdk::data_objects::DataType::FLOAT,
                       hipdnn_data_sdk::data_objects::DataType::FLOAT>(map);

        // FP8 E5M2 input with E8M0 scale, float output/compute (real MX dequantize)
        addPlanBuilder<hipdnn_data_sdk::data_objects::DataType::FP8_E5M2,
                       hipdnn_data_sdk::data_objects::DataType::FP8_E8M0,
                       hipdnn_data_sdk::data_objects::DataType::FLOAT,
                       hipdnn_data_sdk::data_objects::DataType::FLOAT>(map);
