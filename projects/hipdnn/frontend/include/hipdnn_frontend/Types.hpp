...
/**
 * @brief Convert backend hipdnnPointwiseMode_t to frontend PointwiseMode
 *
 * Maps the backend C API pointwise mode enum to the frontend PointwiseMode.
 * Used by the pointwise unpacker to reconstruct frontend attributes from
 * backend descriptors.
 *
 * @param mode The backend hipdnnPointwiseMode_t value
 * @return A pair of the frontend PointwiseMode and an Error (empty on success)
 */
