                         ...
                         is_same_v<OutLayout, NHWGK>)
            {
                             ...
                             is_same_v<ComputeTypeB, half_t>)
                {
                    ...
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_f16_wavelet_pad0_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_f16_wavelet_3way_default_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_f16_wavelet_3way_pad0_instances(
                        op_ptrs);
                             ...
                             is_same_v<ComputeTypeB, ck::bhalf_t>)
                {
                    ...
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_bf16_wavelet_pad0_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_bf16_wavelet_3way_default_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_bf16_wavelet_3way_pad0_instances(
                        op_ptrs);
                         ...
                         is_same_v<OutLayout, NDHWGK>)
            {
                             ...
                             is_same_v<ComputeTypeB, half_t>)
                {
                    ...
                    add_device_grouped_conv3d_bwd_weight_xdl_ndhwgc_gkzyxc_ndhwgk_f16_wavelet_pad0_instances(
                        op_ptrs);
                    add_device_grouped_conv3d_bwd_weight_xdl_ndhwgc_gkzyxc_ndhwgk_f16_wavelet_3way_default_instances(
                        op_ptrs);
                    add_device_grouped_conv3d_bwd_weight_xdl_ndhwgc_gkzyxc_ndhwgk_f16_wavelet_3way_pad0_instances(
                        op_ptrs);
                             ...
                             is_same_v<ComputeTypeB, ck::bhalf_t>)
                {
                    ...
                    add_device_grouped_conv3d_bwd_weight_xdl_ndhwgc_gkzyxc_ndhwgk_bf16_wavelet_pad0_instances(
                        op_ptrs);
                    add_device_grouped_conv3d_bwd_weight_xdl_ndhwgc_gkzyxc_ndhwgk_bf16_wavelet_3way_default_instances(
                        op_ptrs);
                    add_device_grouped_conv3d_bwd_weight_xdl_ndhwgc_gkzyxc_ndhwgk_bf16_wavelet_3way_pad0_instances(
                        op_ptrs);
