                                 ...
                                 ck_tile::HostTensor<CDataType>& c_m_n_host_result)
{
    if(verify == 1)
    {
        ...
        using AQuantGroupSize = typename SelectedKernel::AQuantGroupSize;
        using BQuantGroupSize = typename SelectedKernel::BQuantGroupSize;
        ck_tile::reference_gemm_abquant<ADataType,
                                        ...
                                        AQuantGroupSize,
                                        BQuantGroupSize>(
            a_m_k, aq_m_qk, bq_qk_n, b_k_n, c_m_n_host_result);
    }
}
